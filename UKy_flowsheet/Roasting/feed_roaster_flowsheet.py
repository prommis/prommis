...
def main(m=None):
    ...
    print('Total mass flow of dry organic free impurity in feed stream=', pyo.value(m.fs.roaster.flow_mas_impurity_feed[0]))
    print('Un mass fraction in dry organic free feed', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_feed[0,'Un']))
    print('Al mass fraction in dry organic free feed', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_feed[0,'Al']))
    print('Ca mass fraction in dry organic free feed', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_feed[0,'Ca']))
    print('Fe mass fraction in dry organic free feed', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_feed[0,'Fe']))
    print('Si mass fraction in dry organic free feed', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_feed[0,'Si']))
    print('Total mass flow of recovered solid product=', pyo.value(m.fs.roaster.flow_mas_product_recovered[0]))
    print('Un mass fraction in recovered solid product', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_product[0,'Un']))
    print('Al mass fraction in recovered solid product', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_product[0,'Al']))
    print('Ca mass fraction in recovered solid product', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_product[0,'Ca']))
    print('Fe mass fraction in recovered solid product', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_product[0,'Fe']))
    print('Si mass fraction in recovered solid product', pyo.value(m.fs.roaster.mass_frac_comp_impurity_ele_product[0,'Si']))
    ...
    print('mass flow rate of solid outlet=', pyo.value(m.fs.roaster.solid_out[0].flow_mass))
...
def create_model(m):
    ...
    m.fs.roaster = REEFeedRoaster(
        ...
        ree_list = ["Sc","Y","La","Ce","Pr","Nd","Sm","Eu","Gd","Tb","Dy","Ho","Er","Tm","Yb","Lu"]
    )
