...
def main(m=None):
    ...
    print('Solid feed mass flow =', m.fs.roaster.flow_mas_feed[0].value, 'kg/s')
...
def set_inputs(m):
    ...
    m.fs.roaster.flow_mas_feed.fix((0.12+0.04372)/3600)
    
    # mass fraction of moisture
    m.fs.roaster.mass_frac_moist_feed.fix(1-0.266)
