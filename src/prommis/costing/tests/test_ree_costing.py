...
def test_REEUnitModelCostingBlock_defaults():
    ...
    m.fs.unit.costing.bare_erected_cost.display()
...
#             expr=0.303736
#             * 1e-6
#             * getattr(pyunits, "MUSD_" + CEPCI_year)
#             / pyunits.ton
...
#             rates=rates,
#             prices={
#                 "dummy": 1 * getattr(pyunits, "USD_" + CEPCI_year) / pyunits.kg,
#             },
#             fixed_OM=True,
#             variable_OM=True,
...
#                     to_units=getattr(pyunits, "MUSD_" + CEPCI_year),
#                 )
#             )
#         )
...
#         # add initialize
#         REECostingData.costing_initialization(model.fs.costing)
#         REECostingData.initialize_fixed_OM_costs(model.fs.costing)
#         REECostingData.initialize_variable_OM_costs(model.fs.costing)
...
#         REECostingData.display_flowsheet_cost(model.fs.costing)
...
#         # add costing
#         model.fs.custom_vessel.costing = REEUnitModelCostingBlock(
...
#         m.fs.stage1.costing = REEUnitModelCostingBlock(
#             flowsheet_costing_block=m.fs.costing,
...
#             },
#         )
#         m.fs.stage2.costing = REEUnitModelCostingBlock(
#             flowsheet_costing_block=m.fs.costing,
#             costing_method=DiafiltrationCostingData.cost_membranes,
#             costing_method_arguments={
...
#             },
#         )
#         m.fs.stage3.costing = REEUnitModelCostingBlock(
#             flowsheet_costing_block=m.fs.costing,
#             costing_method=DiafiltrationCostingData.cost_membranes,
#             costing_method_arguments={
...
#             },
#         )
#         m.fs.cascade.costing = REEUnitModelCostingBlock(
#             flowsheet_costing_block=m.fs.costing,
...
#             },
#         )
#         m.fs.feed_pump.costing = REEUnitModelCostingBlock(
#             flowsheet_costing_block=m.fs.costing,
...
#             },
#         )
#         m.fs.diafiltrate_pump.costing = REEUnitModelCostingBlock(
#             flowsheet_costing_block=m.fs.costing,
#             costing_method=DiafiltrationCostingData.cost_pump,
#             costing_method_arguments={
#                 "inlet_pressure": pyunits.convert(
...
#     REECostingData.costing_initialization(m.fs.costing)
#     solver = get_solver()
#     results = solver.solve(m, tee=True)
#     assert_optimal_termination(results)
#     dt.assert_no_numerical_warnings()
...
#     # check that dictionaries were appended correctly
#     REE_costing_params = load_REE_costing_dictionary()  # UKy
#     assert m.fs.unit.costing.costing_method_arguments["additional_costing_params"] == [
#         REE_costing_params,
#         additional_costing_params,
...
#     REECostingData.costing_initialization(m.fs.costing)
#     REECostingData.initialize_fixed_OM_costs(m.fs.costing)
#     REECostingData.initialize_variable_OM_costs(m.fs.costing)
#     solver = get_solver()
#     results = solver.solve(m, tee=True)
#     assert_optimal_termination(results)
#     dt.assert_no_numerical_warnings()
...
#     with pytest.raises(
#         AttributeError,
#         match="_ScalarREECosting' object has no attribute 'plant_overhead_cost'",
#     ):
#         m.fs.costing.build_process_costs(
#             fixed_OM=False,
#             variable_OM=True,
...
#     ):
#         REECostingData.verify_calculate_from_costing_block(m.fs.costing)
...
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=False)
#     m.fs.costing = REECosting(discount_percentage=10)

#     REECostingData.assert_config_argument_set(m.fs.costing, "discount_percentage")
...
#     REECostingData.verify_percentages_list(m.fs, "capital_expenditure_percentages")
...
#     ):
#         REECostingData.verify_percentages_list(
...
#     with expectation:
#         REECostingData.assert_Pyomo_object(m.fs, "x")
...
#     REECostingData.economy_of_numbers(
#         m.fs.costing,
#         cum_num_units=5,
...
# @pytest.mark.unit
# def test_REE_costing_phaseout_years_notlist():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting()
...
#     with pytest.raises(
#         TypeError, match="phaseout_years must be a list of year values. "
#     ):
#         m.fs.costing.build_process_costs(
...
# @pytest.mark.unit
# def test_REE_costing_phaseout_fractions_notlist():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting()
...
#     with pytest.raises(
#         TypeError, match="phaseout_fractions must be a list of fraction values. "
#     ):
#         m.fs.costing.build_process_costs(
...
# @pytest.mark.unit
# def test_REE_costing_phaseout_unequal_lengths():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting()
...
#     with pytest.raises(
#         ValueError,
#         match="phaseout_years and phaseout_fractions must have the same length. ",
#     ):
#         m.fs.costing.build_process_costs(
#             phaseout_years=[2031, 2032, 2033, 2034],
#             phaseout_fractions=[0.75, 0.50, 0.25],
#             consider_phaseout=True,
#         )
...
# @pytest.mark.unit
# def test_REE_costing_phaseout_years_not_chronological():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting()
...
#     with pytest.raises(
#         ValueError,
#         match=r"phaseout_years must be in chronological \(ascending\) order\. ",
#     ):
#         m.fs.costing.build_process_costs(
#             phaseout_years=[2033, 2031, 2032],
#             consider_phaseout=True,
#         )


# @pytest.mark.unit
# def test_REE_costing_phaseout_fractions_outofrange():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting()
...
#     with pytest.raises(
#         ValueError, match="phaseout_fractions must contain values between 0 and 1. "
#     ):
#         m.fs.costing.build_process_costs(
#             phaseout_fractions=[0.75, 1.5, 0.25],
#             consider_phaseout=True,
#         )


# @pytest.mark.unit
# def test_REE_costing_phaseout_no_ce_indexyear():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting()
...
#     with pytest.raises(
#         ValueError,
#         match=r"CEPCI_year must be defined to calculate production incentive charge.",
#     ):
#         m.fs.costing.build_process_costs(
#             pure_product_output_rates={
#                 "Sc2O3": 1.9 * pyunits.kg / pyunits.hr,
...
# @pytest.mark.unit
# def test_REE_costing_phaseout_no_capex_period():
#     m = pyo.ConcreteModel()
#     m.fs = FlowsheetBlock(dynamic=True, time_units=pyunits.s)
#     m.fs.costing = REECosting(
#         discount_percentage=10,
