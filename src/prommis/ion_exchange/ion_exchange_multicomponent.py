...
#. **ion_exchange_multicomponent_base**: The base model that provides the
...
#. **ion_exchange_multicomponent**: The equilibrium model that
...
#. **ion_exchange_cost_block** and **ion_exchange_cost_model**: The
