...
class MixedAcidLeachReactionScaler(CustomScalerBase):
    """
...
@declare_process_block_class("MixedAcidLeachingReactionParameterBlock")
class MixedAcidLeachingReactionParameterData(
    ...
    * Impurities: Al2O3, CaO, Fe2O3
    ...
    def build(self):
        ...
        self._reaction_block_class = MixedAcidLeachingReactionBlock
...
class _MixedAcidLeachingReactionBlock(ProcessBlock):
    pass


@declare_process_block_class(
    "MixedAcidLeachingReactionBlock", block_class=_MixedAcidLeachingReactionBlock
)
class MixedAcidLeachingReactionData(ProcessBlockData):
    default_scaler = MixedAcidLeachReactionScaler
    ...
    def build(self):
        ...
        def rule_reaction_rate(b, r):
            ...
            h_conc = l_block.conc_mol_comp["H_+"]
