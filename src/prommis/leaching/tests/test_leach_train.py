...
#
# @pytest.mark.unit
# def test_structural_issues(model_ub):
...
# @pytest.mark.component
# @pytest.mark.solver
# def test_initialize_and_solve(model_ub):
#     # Cannot separate initialization, as it fails to converge in first pass
...
# @pytest.mark.component
# @pytest.mark.solver
# def test_numerical_issues(model_ub):
#     dt = DiagnosticsToolbox(model_ub)
#     dt.assert_no_numerical_warnings()
#
#
...
@pytest.mark.unit
def test_structural_issues(model_lb):
...
@pytest.mark.component
@pytest.mark.solver
def test_initialize_and_solve(model_lb):
    # Cannot separate initialization, as it fails to converge in first pass
...
@pytest.mark.component
@pytest.mark.solver
def test_numerical_issues(model_lb):
    dt = DiagnosticsToolbox(model_lb)
    dt.assert_no_numerical_warnings()
