...
class REEOxalateScaler(CustomScalerBase):
    """
    Scaler for REE oxalate solids.
    """
...
@declare_process_block_class("REEOxalateParameterBlock")
class REEOxalateParameterData(PhysicalParameterBlock):
    """
    ...
    * Rare Earth Oxalates: "Al2(C2O4)3(s)", "Fe2(C2O4)3(s)", "Sc2(C2O4)3(s)",
    ...
    def build(self):
        ...
        self._state_block_class = REEOxalateStateBlock
...
class _REEOxalateStateBlock(StateBlock):
    default_scaler = REEOxalateScaler
...
@declare_process_block_class("REEOxalateStateBlock", block_class=_REEOxalateStateBlock)
class REEOxalateStateBlockData(StateBlockData):
    """
