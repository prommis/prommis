...
from prommis.properties.ree_oxalate_properties import (
    REEOxalateParameterBlock,
    REEOxalateScaler,
)
...
def test_build():
    ...
    m.fs.prec_solid = REEOxalateParameterBlock()
    ...
    assert m.fs.state[0].default_scaler is REEOxalateScaler
