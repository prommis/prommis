...
class MixedAcidREEOxalateRoasterScaler(CustomScalerBase):
    """
...
# ----------------------------------------------------------------------------------------------------------
@declare_process_block_class("MixedAcidREEOxalateRoaster")
class MixedAcidREEOxalateRoasterData(UnitModelBlockData):
    """
    Simple 0D roaster model with mass and energy balance only
    """

    default_scaler = MixedAcidREEOxalateRoasterScaler
...
**False** - exclude pressure change terms.}""",
    ...
    def build(self):
        ...
        super(MixedAcidREEOxalateRoasterData, self).build()
    ...
    def _make_mass_balance(self):
        ...
        def flow_mol_comp_feed_eqn(b, t, i):
            return b.flow_mol_comp_feed[t, i] == pyunits.convert(
                b.solid_in[t].flow_mol_comp[_metal_to_solid_compound[i]],
