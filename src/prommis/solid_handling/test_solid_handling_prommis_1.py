from solid_handling_prommis import CrushAndBreakageUnit  # Replace your_module_name with the actual name of your Python file
...
model.fs.properties = BTXParameterBlock(default={"valid_phase": ('Liq', 'Vap'), "activity_coeff_model": "Ideal"})
