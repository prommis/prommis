...
class MixedAcidSolventExtractionScaler(CustomScalerBase):
    """
...
class MixedAcidSolventExtractionInitializer(ModularInitializerBase):
    """
...
@declare_process_block_class("MixedAcidSolventExtraction")
class MixedAcidSolventExtractionData(UnitModelBlockData):

    default_initializer = MixedAcidSolventExtractionInitializer
    default_scaler = MixedAcidSolventExtractionScaler
