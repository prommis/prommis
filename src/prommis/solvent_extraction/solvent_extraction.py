...
class SolventExtractionData(UnitModelBlockData):
    ...
    def build(self):
        ...
        self.partition_coefficient = Param(
            ...
            initialize={
                ("aqueous", "organic", "Al"): 5.2 / 100,
                ("aqueous", "organic", "Ca"): 3.0 / 100,
                ("aqueous", "organic", "Fe"): 24.7 / 100,
                ("aqueous", "organic", "Sc"): 99.1 / 100,
                ("aqueous", "organic", "Y"): 99.9 / 100,
                ("aqueous", "organic", "La"): 32.4 / 100,
                ("aqueous", "organic", "Ce"): 58.2 / 100,
                ("aqueous", "organic", "Pr"): 58.2 / 100,
                ("aqueous", "organic", "Nd"): 87.6 / 100,
                ("aqueous", "organic", "Sm"): 99.9 / 100,
                ("aqueous", "organic", "Gd"): 69.8 / 100,
                ("aqueous", "organic", "Dy"): 96.6 / 100,
            },
            mutable=True,
