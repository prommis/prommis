...
Figure 1 shows the byproduct recovery determine tree. The wast disposal cost, estimated cost of 
...
.. figure:: ../byproduct_recovery_determine_tree.png
    :width: 800
    :align: center
...
class ByproductRecoveryData(UnitModelBlockData):
    ...
    def build(self):
        ...
        self.waste_disposal_cost = Var(
            ...
            initialize=5,
            units=pyunits.USD_2021 / pyunits.kg,
            doc="Revenue credit from waste disposal",
        )
...
if __name__ == "__main__":
    ...
    material_list = [
        ...
        "Copper",
        "Zinc",
    ]  # Flexible number of materials

    # Create a Pyomo ConcreteModel
    model = ConcreteModel()

    # Add an instance of the ByproductRecovery process block with a flexible number of materials
