...
def assert_solution_equivalent(expected_results):
    """
    ...
    for name, data in expected_results.items():
        var_obj = data["var_or_expr"]
        expected_values_dict = data["values"]

        for index, (expected_value, rel, abs) in expected_values_dict.items():
            component_to_test = var_obj if index is None else var_obj[index]
...
def test_solution(system_frame):
    ...
    # Leach Unit Results
    expected_results["leach.solid_outlet.flow_mass"] = {
        "var_or_expr": model.fs.leach.solid_outlet.flow_mass,
        "values": {0: (22.238837, tol, None)},
    }
    expected_results["leach.solid_outlet.mass_frac_comp"] = {
        "var_or_expr": model.fs.leach.solid_outlet.mass_frac_comp,
        "values": {
    ...
    expected_results["leach.liquid_outlet.flow_vol"] = {
        "var_or_expr": model.fs.leach.liquid_outlet.flow_vol,
        "values": {0: (865.2653, tol, None)},
    }
    expected_results["leach.liquid_outlet.conc_mass_comp"] = {
        "var_or_expr": model.fs.leach.liquid_outlet.conc_mass_comp,
        "values": {
    ...
    rs_ms = model.fs.solex_rougher_strip.mscontactor
    expected_results["solex_rougher_strip.mscontactor.organic_outlet.flow_vol"] = {
        "var_or_expr": rs_ms.organic_outlet.flow_vol,
        "values": {0: (62.01, tol, None)},
    }
    expected_results[
        "solex_rougher_strip.mscontactor.organic_outlet.conc_mass_comp"
    ] = {
        "var_or_expr": rs_ms.organic_outlet.conc_mass_comp,
        "values": {
    ...
    expected_results["solex_rougher_strip.mscontactor.aqueous_outlet.flow_vol"] = {
        "var_or_expr": rs_ms.aqueous_outlet.flow_vol,
        "values": {0: (9.0, tol, None)},
    }
    expected_results[
        "solex_rougher_strip.mscontactor.aqueous_outlet.conc_mass_comp"
    ] = {
        "var_or_expr": rs_ms.aqueous_outlet.conc_mass_comp,
        "values": {
            (0, "H2O"): (1000000.0, tol, None),
    ...
    cs_ms = model.fs.solex_cleaner_strip.mscontactor
    expected_results["solex_cleaner_strip.mscontactor.organic_outlet.flow_vol"] = {
        "var_or_expr": cs_ms.organic_outlet.flow_vol,
        "values": {0: (62.010, tol, None)},
    }
    expected_results[
        "solex_cleaner_strip.mscontactor.organic_outlet.conc_mass_comp"
    ] = {
        "var_or_expr": cs_ms.organic_outlet.conc_mass_comp,
        "values": {
    ...
    expected_results["solex_cleaner_strip.mscontactor.aqueous_outlet.flow_vol"] = {
        "var_or_expr": cs_ms.aqueous_outlet.flow_vol,
        "values": {0: (9, tol, None)},
    }
    expected_results[
        "solex_cleaner_strip.mscontactor.aqueous_outlet.conc_mass_comp"
    ] = {
        "var_or_expr": cs_ms.aqueous_outlet.conc_mass_comp,
        "values": {
    ...
    precip_cv = model.fs.precipitator.cv_aqueous.properties_out[0]
    expected_results["precipitator.cv_aqueous.properties_out[0].flow_vol"] = {
        "var_or_expr": precip_cv.flow_vol,
        "values": {None: (9, tol, None)},
    }
    expected_results["precipitator.cv_aqueous.properties_out[0].conc_mass_comp"] = {
        "var_or_expr": precip_cv.conc_mass_comp,
        "values": {
            "Al": (0.86154, tol, None),
            "Ca": (0.23563, tol, None),
    ...
    precip_outlet = model.fs.precipitator.precipitate_outlet
    expected_results["precipitator.precipitate_outlet.temperature"] = {
        "var_or_expr": precip_outlet.temperature,
        "values": {0: (348.15, tol, None)},
    }
    expected_results["precipitator.precipitate_outlet.flow_mol_comp"] = {
        "var_or_expr": precip_outlet.flow_mol_comp,
        "values": {
    ...
    # Roaster Results
    roaster_gas = model.fs.roaster.gas_outlet
    expected_results["roaster.gas_outlet.flow_mol"] = {
        "var_or_expr": roaster_gas.flow_mol,
        "values": {0: (0.021699, tol, None)},
    }
    expected_results["roaster.gas_outlet.temperature"] = {
        "var_or_expr": roaster_gas.temperature,
        "values": {0: (873.15, tol, None)},
    }
    expected_results["roaster.gas_outlet.pressure"] = {
        "var_or_expr": roaster_gas.pressure,
        "values": {0: (101325, tol, None)},
    }
    expected_results["roaster.gas_outlet.mole_frac_comp"] = {
        "var_or_expr": roaster_gas.mole_frac_comp,
        "values": {
    ...
    # Standalone Flowsheet Variables
    fs = model.fs
    expected_results["leach_mixer.outlet.flow_vol"] = {
        "var_or_expr": fs.leach_mixer.outlet.flow_vol,
        "values": {0: (865.078, tol, None)},
    }
    expected_results["rougher_org_make_up.outlet.flow_vol"] = {
        "var_or_expr": fs.rougher_org_make_up.outlet.flow_vol,
        "values": {0: (6.201, tol, None)},
    }
    expected_results["solex_rougher_load.mscontactor.aqueous_outlet.flow_vol"] = {
        "var_or_expr": fs.solex_rougher_load.mscontactor.aqueous_outlet.flow_vol,
        "values": {0: (621.9757, tol, None)},
    }
    expected_results["solex_rougher_scrub.mscontactor.aqueous_outlet.flow_vol"] = {
        "var_or_expr": fs.solex_rougher_scrub.mscontactor.aqueous_outlet.flow_vol,
        "values": {0: (90, tol, None)},
    }
    expected_results["solex_rougher_strip.mscontactor.aqueous_outlet.flow_vol_2"] = {
        "var_or_expr": fs.solex_rougher_strip.mscontactor.aqueous_outlet.flow_vol,
        "values": {0: (9, tol, None)},
    }
    expected_results["acid_feed1.outlet.flow_vol"] = {
        "var_or_expr": fs.acid_feed1.outlet.flow_vol,
        "values": {0: (90, tol, None)},
    }
    expected_results["acid_feed2.outlet.flow_vol"] = {
        "var_or_expr": fs.acid_feed2.outlet.flow_vol,
        "values": {0: (9, tol, None)},
    }
    expected_results["acid_feed3.outlet.flow_vol"] = {
        "var_or_expr": fs.acid_feed3.outlet.flow_vol,
        "values": {0: (9, tol, None)},
    }
    expected_results["rougher_sep.inlet.flow_vol"] = {
        "var_or_expr": fs.rougher_sep.inlet.flow_vol,
        "values": {0: (62.01, tol, None)},
    }
    expected_results["load_sep.inlet.flow_vol"] = {
        "var_or_expr": fs.load_sep.inlet.flow_vol,
        "values": {0: (621.9757, tol, None)},
    }
    expected_results["scrub_sep.inlet.flow_vol"] = {
        "var_or_expr": fs.scrub_sep.inlet.flow_vol,
        "values": {0: (90, tol, None)},
    }
    expected_results["rougher_mixer.outlet.flow_vol"] = {
        "var_or_expr": fs.rougher_mixer.outlet.flow_vol,
        "values": {0: (62.01, tol, None)},
    }
    expected_results["rougher_organic_purge.inlet.flow_vol"] = {
        "var_or_expr": fs.rougher_organic_purge.inlet.flow_vol,
        "values": {0: (6.201, tol, None)},
    }
    expected_results["solex_cleaner_load.mscontactor.aqueous_outlet.flow_vol"] = {
        "var_or_expr": fs.solex_cleaner_load.mscontactor.aqueous_outlet.flow_vol,
        "values": {0: (16.29, tol, None)},
    }
    expected_results["solex_cleaner_strip.mscontactor.aqueous_outlet.flow_vol_2"] = {
        "var_or_expr": fs.solex_cleaner_strip.mscontactor.aqueous_outlet.flow_vol,
        "values": {0: (9, tol, None)},
    }
    expected_results["cleaner_org_make_up.outlet.flow_vol"] = {
        "var_or_expr": fs.cleaner_org_make_up.outlet.flow_vol,
        "values": {0: (6.201, tol, None)},
    }
    expected_results["cleaner_mixer.outlet.flow_vol"] = {
        "var_or_expr": fs.cleaner_mixer.outlet.flow_vol,
        "values": {0: (62.01, tol, None)},
    }
    expected_results["cleaner_sep.inlet.flow_vol"] = {
        "var_or_expr": fs.cleaner_sep.inlet.flow_vol,
        "values": {0: (62.01, tol, None)},
    }
    expected_results["leach_sx_mixer.outlet.flow_vol"] = {
        "var_or_expr": fs.leach_sx_mixer.outlet.flow_vol,
        "values": {0: (621.97569, tol, None)},
    }
    expected_results["cleaner_organic_purge.inlet.flow_vol"] = {
        "var_or_expr": fs.cleaner_organic_purge.inlet.flow_vol,
        "values": {0: (6.201, tol, None)},
    }
    expected_results["sl_sep1.recovered_liquid_outlet.flow_vol"] = {
        "var_or_expr": fs.sl_sep1.recovered_liquid_outlet.flow_vol,
        "values": {0: (605.68569, tol, None)},
    }
    expected_results["sl_sep2.recovered_liquid_outlet.flow_vol"] = {
        "var_or_expr": fs.sl_sep2.recovered_liquid_outlet.flow_vol,
        "values": {0: (8.1, tol, None)},
    }
    expected_results["precip_sep.inlet.flow_vol"] = {
        "var_or_expr": fs.precip_sep.inlet.flow_vol,
        "values": {0: (8.1, tol, None)},
    }
    expected_results["precip_sx_mixer.outlet.flow_vol"] = {
        "var_or_expr": fs.precip_sx_mixer.outlet.flow_vol,
        "values": {0: (16.29, tol, None)},
    }
    expected_results["precip_purge.inlet.flow_vol"] = {
        "var_or_expr": fs.precip_purge.inlet.flow_vol,
        "values": {0: (0.81, tol, None)},
    }

    assert_solution_equivalent(expected_results)
...
def test_costing_solution(system_frame):
    ...
    expected_results = {
        "fs.costing.total_plant_cost": {
            "var_or_expr": costing.total_plant_cost,
            "values": {None: (1.18071, tol, None)},
        },
        "fs.costing.total_BEC": {
            "var_or_expr": costing.total_BEC,
            "values": {None: (0.39754, tol, None)},
        },
        "fs.costing.total_installation_cost": {
            "var_or_expr": costing.total_installation_cost,
            "values": {None: (0.78316, tol, None)},
        },
        "fs.costing.other_plant_costs": {
            "var_or_expr": costing.other_plant_costs,
            "values": {None: (7.5987e-06, tol, None)},
        },
        "fs.costing.total_fixed_OM_cost": {
            "var_or_expr": costing.total_fixed_OM_cost,
            "values": {None: (6.8166, tol, None)},
        },
        "fs.costing.total_variable_OM_cost": {
            "var_or_expr": costing.total_variable_OM_cost,
            "values": {0: (1.3634, tol, None)},
        },
        "fs.costing.total_sales_revenue": {
            "var_or_expr": costing.total_sales_revenue,
            "values": {None: (2.69422e-5, None, tol)},
        },
        "fs.costing.land_cost": {
            "var_or_expr": costing.land_cost,
            "values": {None: (6.1234e-5, tol, None)},
        },
    }
    assert_solution_equivalent(expected_results)
