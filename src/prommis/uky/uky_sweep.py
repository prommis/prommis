...
#################################################################################
from prommis.uky.parameter_sweep import LinearSample, parameter_sweep
import prommis.uky.uky_flowsheet as uky

import os
from prommis.uky.parameter_sweep.sweep_visualizer import line_plot, contour_plot
...
def set_up_sensitivity(m):
    ...
    outputs["Product Mass Flow"] = m.fs.roaster.flow_mas_product[0]

    opt_function = uky.solve
...
def run_analysis(
    case_num, nx, interpolate_nan_outputs=True, output_filename=None
):
